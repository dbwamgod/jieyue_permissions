...
export const otherRouter = {
    ...
    redirect: '/component/focus-large',
    component: Main,
    children: [
        { path: 'organization-management-system', title: '集群大盘', name: 'home_index', component: () => import('@/views/my-components/text-editor/text-editor.vue') },
    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                name: 'spark-table',
                title: 'SPARK工作台',
                component: () => import('@/views/my-components/spark-table/spark-table.vue')
            },
            {
                path: 'task-warning',
                icon: 'pound',
            ...
            },
            {
                ...
                name: 'data_com',
                title: '元数据对比',
                component: () => import('@/views/my-components/data_com/data_com.vue')
            },
