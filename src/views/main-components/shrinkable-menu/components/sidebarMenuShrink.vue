            ...
            <div style="text-align: center;" key="1indd">
                <Dropdown transfer placement="right-start" :key="1" @on-click="changeMenu" v-if="dropdown.homework">
                    ...
                    <DropdownMenu style="width: 200px;" slot="list">
                        <DropdownItem name="home_index" key="1-1" v-if="menuDisplay.fouse"><span
                                style="padding-left:10px;">集群大盘</span></DropdownItem>
                        <DropdownItem name="task-warning" key="1-2" v-if="menuDisplay.early_warn"><span
                                style="padding-left:10px;">任务预警</span></DropdownItem>
                        <DropdownItem name="task-inquire" key="1-3" v-if="menuDisplay.check"><span
                                style="padding-left:10px;">任务查询</span></DropdownItem>
                        <DropdownItem name="task-table" key="1-4" v-if="menuDisplay.record"><span
                                style="padding-left:10px;">任务记录</span></DropdownItem>
                        <DropdownItem name="spark-table" key="1-5" v-if="menuDisplay.spark"><span
                                style="padding-left:10px;">SPARK工作台</span></DropdownItem>
                        <DropdownItem name="HUE-table" key="1-6" v-if="menuDisplay.hue"><span
                                style="padding-left:10px;">HUE工作台</span></DropdownItem>
                        <DropdownItem name="data_com" key="1-7" v-if="menuDisplay.compare"><span
                                style="padding-left:10px;">元数据对比</span></DropdownItem>
                    </DropdownMenu>
                </Dropdown>
                <Dropdown transfer v-if="dropdown.azkanban" placement="right-start" :key="2" @on-click="changeMenu">
                    ...
                    <DropdownMenu style="width: 200px;" slot="list">
                        <DropdownItem v-if="menuDisplay.azkanban" name="task-dispatch" key="2-1"><span
                                style="padding-left:10px;">azkaban</span></DropdownItem>
                    </DropdownMenu>
                </Dropdown>
                <Dropdown transfer v-if="dropdown.jurisdiction" placement="right-start" :key="3" @on-click="changeMenu">
                    ...
                    <DropdownMenu style="width: 200px;" slot="list">
                        <DropdownItem v-if="menuDisplay.jurisdiction" name="add-jurisdiction" key="3-1"><span
                                style="padding-left:10px;">HIVE权限管理</span></DropdownItem>
                        <DropdownItem v-if="menuDisplay.batch" name="workflow" key="3-2"><span
                                style="padding-left:10px;">批量管理</span></DropdownItem>
                    </DropdownMenu>
                </Dropdown>
            </div>
        </template>
