                                ...
                                if (res.status === 200) {
                                    ...
                                    this.$axios({//银河平台 if 页面
                                        ...
                                        if(res.data.data["spark.submit"]){
                                           ...
                                           Cookies.set('PLAY_SESSION',sparkSubmit.cookies[0].value,{ 'Domain':'.jy2tehdp03:9011' });
                                           console.log(Cookies.get('PLAY_SESSION'))
                                        //    document.cookie.domain='jy2tehdp03:9011';
                                       /*    if(sparkSubmit.cookies){
                                               sparkSubmit.cookies.forEach(function (e) {
                                                   if("PLAY_SESSION"==e.name){
                                                       ...
                                                       document.cookie="PLAY_SESSION=\""+e.value+"\""
                                                   }
                                               })
                                           }*/
                                        }
